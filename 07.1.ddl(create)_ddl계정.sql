...
INSERT INTO MEMBER VALUES(2,'user02','pwd02','나순이','여','010-1221-2446','na@naver.com','25/02/06');
...
/*
    ...
    - 데이터 무결성 보장을 목적으로 한다.
     ...
     2) 참조 무결성 제약조건 : FOREIGN KEY(외래키) 조건위배  
...
INSERT INTO MEM_NOTNULL VALUES(2,'user02','pwd02','나순이','여','010-1221-2446','na@naver.com');
...
--NO, ID 가 중복되었음에도 잘 추가
----------------------------------------------------------
/*
    UNIQUE 제약조건
    해당컬럼에 중복된 값이 들어가서는 안됨
    컬럼값에 중복값을 제한하는 제약조건
...
INSERT INTO MEM_UNIQUE VALUES(2,'user02','pwd02','나순이','여','010-1221-2446','na@naver.com');
...
INSERT INTO MEM_UNIQUE2 VALUES(2,'user02','pwd02','나순이','여','010-1221-2446','na@naver.com');
...
INSERT INTO MEM_UNIQUE3 VALUES(2,'user02','pwd02','나순이','여','010-1221-2446','na@naver.com');
